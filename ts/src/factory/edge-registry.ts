...
export const EDGES: readonly SemanticEdge[] = [
  ...
  // HARD CUTOVER: runtime p2a is V3-only; historical V2 remains parseable, not executable.
  { edge_id: 'p2a', source_planet: 'parzifal+janus+artemis+metis+star',
    source_contract: 'IdentityLock+ProductTruth+EvidenceBundle+HookDirective+AresV3CommandScope',
    target_planet: 'ares', target_node_id: 'ares.scripts.generate',
    target_contract: 'AresP2ATargetProjection', policy_id: 'policy.p2a', timeout_ms: 30000,
    criticality: 'required' },
