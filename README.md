...
유료 실행 권한은 현재 USD 원가 프로필까지 검증한 `FactoryPaidBudgetResolutionV2`만 발급한다. 장면 영상 영수증은 사전검증된 4초·24fps·720×1280·무음 요청 전체를 포함하며, 장면 세트→팬인→최종 영수증은 같은 비직렬화 요청 권한을 다시 대조해야 한다.
